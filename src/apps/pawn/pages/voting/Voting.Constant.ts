import icStatusClosed from "src/apps/pawn/pages/voting/images/ic_status_closed.svg";
import icStatusSoon from "src/apps/pawn/pages/voting/images/ic_status_soon.svg";
import icStatusVoteNow from "src/apps/pawn/pages/voting/images/ic_status_vote_now.svg";
