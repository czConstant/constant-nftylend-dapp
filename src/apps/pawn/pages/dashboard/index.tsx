...
import Overview from 'src/apps/pawn/views/dashboard/overview';
import MyLoans from 'src/apps/pawn/views/dashboard/myLoans';
import MyOffers from 'src/apps/pawn/views/dashboard/myOffers';
import MyAssets from 'src/apps/pawn/views/dashboard/myAssets';
import Affiliates from 'src/apps/pawn/views/dashboard/affiliates';
