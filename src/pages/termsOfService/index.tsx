  ...
  return (
    ...
    >
      <div>
        ...
        <p>
          This Agreement is between you and MyConstant concerning your use of
        ...
        <p>
          ...
          FURTHER SET FORTH IN SECTION 19 BELOW, REQUIRES THE USE OF ARBITRATION
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                any username, password or other information that you provide to
                us in registering. Your username and password are for your
                personal use only and should be kept confidential. You, and not
                MyConstant, are responsible for any use or misuse of your
                username or password, and you must promptly notify us of any
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    or licensed to do so, or for which you are not permitted to
                    do so either by authorization or licensure or by any
                    applicable federal, state, local or foreign laws (including
                    common law), codes, statutes, ordinances, rules,
                    regulations, regulatory bulletins, interpretations or
                    guidance or orders, decrees and orders of, official releases
                    or any other requirements by, any governmental authority or
                  ...
                  <li>
                    ...
                    the Borrower member's source of income, or any other basis
                    prohibited by any Applicable Law, including the Equal Credit
                    Opportunity Act and its implementing regulation, Regulation
                    B or the Fair Housing Act;
                  </li>
                  <li>
                    ...
                    fraudulent or otherwise tortious or illegal, including in
                    connection with the disclosure of insider information under
                    securities law or of another party's trade secrets; (c)
                    obscene, indecent, pornographic or otherwise objectionable;
                    (d) protected by copyright, trademark, trade secret, right
                    of publicity or privacy or any other proprietary right,
                    without the express prior written consent of the applicable
                    owner; (e) information or content that you do not have a
                    right to make available under any law or under contractual
                    or fiduciary relationships; or (f) information or content
                  ...
                  <li>
                    Systematically download and store MyConstant Material;
                  </li>
                  <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                For the avoidance of doubt, MyConstant will have no obligation
                to provide any consulting, implementation, or other professional
                services, except as may be set forth in a separate written
                agreement between you and MyConstant.
              </li>
            </ul>
          </li>
          <li>
            <b>Borrower Obligations.</b>
            <ul>
              <li>
              ...
              <li>
                (a) You agree to comply with MyConstant's Borrower policies and
                ...
                <ul>
                  ...
                  <li>
                    ...
                    and you shall promptly notify MyConstant in writing if you
                  ...
                  <li>
                    You, and not MyConstant, are responsible for re-paying the
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      accordance with MyConstant's then-current cancellation
                      policies; or
                    </li>
                    <li>Your Listing is never accepted.</li>
                  </ul>
                </li>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                You agree to comply with MyConstant's Lender policies and
                practices, as set forth herein, as may be amended from time to
                time, and agree that:
                <ul>
                  <li>
                  ...
                  <li>
                    ...
                    instructions to the Borrower (or if required by MyConstant,
                    to MyConstant); and
                  </li>
                  <li>
                    You will pay all applicable amounts to Borrower and
                    MyConstant in association with the Transaction.
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                MyConstant is not a party to any Transaction, and does not
                represent that MyConstant collects taxes, whether municipal,
              ...
              <li>
                ...
                the fees actually paid, you shall also pay MyConstant's
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                users (the "MyConstant Material"), and all intellectual property
                rights related thereto, are the exclusive property of MyConstant
                ...
                intellectual property rights. Use of the MyConstant Material for
              ...
              <li>
                ...
                place MyConstant under any agency, fiduciary or other
                ...
                MyConstant does not waive any rights to use similar or related
                ideas previously known to MyConstant, or developed by its
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                MyConstant takes no responsibility and assumes no liability for
              ...
              <li>
                ...
                such Third Party Materials. You expressly relieve MyConstant
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                In no event shall MyConstant be obligated to take any action
                would cause MyConstant to be in violation of any Applicable Laws
              ...
              <li>
                ...
                government lists of restricted end users. MyConstant will not be
              ...
              <li>
                ...
                <ul>
                  <li>
                    ...
                    Transactions, Use, and allow MyConstant to Use, your User
                  ...
                  <li>
                    ...
                    law during your time of engagement with MyConstant, and you
                    will immediately inform MyConstant in writing if this status
                    changes; and
                  </li>
                  <li>
          ...
          <li>
            ...
            <ul>
              <li>
                You agree to defend, indemnify and hold harmless MyConstant and
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                MyConstant DISCLAIMS ALL WARRANTIES WITH RESPECT TO THE PLATFORM
                ...
                MADE FOR THE BENEFIT OF BOTH MyConstant AND ITS AFFILIATES, AND
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                MyConstant WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
                ...
                WITHOUT LIMITING THE FOREGOING, MyConstant WILL NOT BE LIABLE
                ...
                AND (D) THE MAXIMUM AGGREGATE LIABILITY OF MyConstant FOR ALL
                DAMAGES, LOSSES AND CAUSES OF ACTION, WHETHER IN CONTRACT, TORT
                (INCLUDING NEGLIGENCE) OR OTHERWISE, SHALL BE THE LESSER OF
                ($100) OR THE FEES PAID TO MyConstant IN CONNECTION WITH THE
                ...
                IN THIS AGREEMENT) ARE MADE FOR THE BENEFIT OF BOTH MyConstant
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    MyConstant may (but is not obligated to) provide you with
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        MyConstant believes that you (a) pose a security risk
                      ...
                      <li>
                        ...
                        liability; MyConstant determines or reasonably suspects
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                relationship formed by this Agreement. MyConstant agrees that
                ...
                writing, MyConstant will cease using the User Marks as provided
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                written consent of MyConstant. Any attempted assignment in
                violation of this Section 20 shall be void. MyConstant may
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                the DMCA permits you to send to MyConstant a counter-notice.
                ...
                to Robert Masiello as follows: By mail to 1390 Market Street
                Suite 200 San Francisco, CA 94102; or by e-mail to
                <a href="mailto:hello@myconstant.com">hello@myconstant.com</a>.
              </li>
              <li>
          ...
          <li>
            <b>Notices; Electronic Consent.</b>
            <ul>
              <li>
              ...
              <li>
                ...
                following address: hello@myconstant.com (or to such other
                address as hello@myconstant.com may designate to you from time
                to time).
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                herein, is the entire agreement between you and MyConstant
                relating to the subject matter hereof, and supersedes any and
                all prior or contemporaneous written or oral agreements or
                understandings between you and MyConstant relating to such
                subject matter.
              </li>
              <li>
                MyConstant shall not be liable for any delay or failure to
                perform its obligations hereunder resulting from any cause
                beyond MyConstant's reasonable control that makes performance
                ...
                information technology systems or services beyond MyConstant's
                reasonable control. You acknowledge that MyConstant does not and
